https://prometheus.io/assets/docs/architecture.svg -----------> architecture check once

After creating EKS cluster then plz add permission for nodegroup goto IAM, Roles, select nodegroup, Add Permissions, search AmazonEBSDriverPolicy, next.
